...
function Toast(props: IToast) {
    ...
    return (
        <div className='animation-in max-w-max flex items-center w-full p-4 text-gray-50 bg-indigo-600 rounded-lg shadow-lg hover:bg-indigo-700'>
            ...
            <button
                type='button'
                className='-mx-1.5 -my-1.5 ml-2 text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8'
                onClick={(e) => {
